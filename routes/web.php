...
Route::group(['middleware' => 'oten'], function () {
    Route::group(['middleware' => 'auth'], function () {
        ...
        */
        ...
        Route::group(['prefix' => 'manufacturers', 'middleware' => ['auth']], function () {
            Route::post('{manufacturers_id}/restore', [ManufacturersController::class, 'restore'])
            ->name('restore/manufacturer');
        });
    ...
    */
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        Route::get('reports/accessories', [ReportsController::class, 'getAccessoryReport'])
